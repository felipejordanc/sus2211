...
![Mapa con Comunas de La Araucanía y Comunidades Indígenas cargadas](figures/tarea03/tarea3_003.png){fig-align="center"}
:::
...
![Menú contextual — opción Propiedades de la capa](figures/tarea03/tarea3_004.png){fig-align="center"}
...
![Ventana de Propiedades — pestaña Simbología con Símbolo Único](figures/tarea03/tarea3_005.png){fig-align="center"}
...
![Simbología Graduada — selección de la variable Pobreza\_1 desde el menú desplegable](figures/tarea03/tarea3_006.png){fig-align="center"}
...
**10.** Elige una **Rampa de color** en el menú desplegable. Puedes usar las opciones predefinidas de QGIS o explorar "Todas las rampas de color". No hay colores obligatorios: experimenta con rampas que transmitan bien la variación en pobreza multidimensional. Se recomienda una rampa que transmita la información cuantitativa de una valor que va "de menos a más", por ejemplo, que va desde colores blancos a colores oscuros en una tonalidad.

![Simbología Graduada - elección de rampa de color](figures/tarea03/tarea3_007.png){fig-align="center"}
...
::: {.callout-tip title="Métodos de clasificación en QGIS"}
El menú desplegable "Modo" define cómo se dividen los datos en clases. Los métodos principales son:

- **Intervalos iguales:** divide el rango total de los datos en clases del mismo ancho. Útil cuando los datos están distribuidos uniformemente, pero puede generar clases vacías si hay valores extremos.
- **Cuantiles (cuenta igual):** asigna el mismo número de observaciones a cada clase. Permite comparar la distribución espacial de forma equilibrada, pero las clases pueden tener rangos muy distintos.
- **Rupturas naturales (Jenks):** agrupa los valores minimizando la varianza dentro de cada clase y maximizando las diferencias entre ellas. Es el método más recomendado para representar datos con agrupaciones naturales.
- **Desviación estándar:** define los límites de clase en función de la desviación estándar respecto a la media. Útil para identificar valores atípicos, pero requiere que los datos se distribuyan aproximadamente de forma normal.
- **Bonito:** genera intervalos "redondos" fáciles de leer. Prioriza la legibilidad sobre la precisión estadística.

El botón **"Clasificar"** aplica el método seleccionado a los datos actuales y genera los intervalos. Debe presionarse cada vez que se cambie el método, el número de clases o la variable, para que QGIS recalcule los rangos.
:::
...
El mapa debería verse así (con la rampa de color de tu elección), con las comunas coloreadas según nivel de pobreza y los puntos de comunidades superpuestos:

![Mapa con simbología graduada en 5 clases para Pobreza Multidimensional y comunidades indígenas](figures/tarea03/tarea3_009.png){fig-align="center"}
...
![Simbología de marcador — opciones de forma, color, tamaño y opacidad para Comunidades Indígenas](figures/tarea03/tarea3_010.png){fig-align="center"}
...
![Herramienta Identificar — panel de resultados con atributos de una comunidad indígena](figures/tarea03/tarea3_013.png){fig-align="center"}
...
![Menú Proyecto → Nueva composición de impresión (Ctrl+P)](figures/tarea03/tarea3_014.png){fig-align="center"}

Asigna un nombre a la composición en el diálogo que aparece (por ejemplo, `Proyecto clase 3`) y haz clic en **Aceptar**.

![Diálogo para nombrar la nueva composición de impresión](figures/tarea03/tarea3_015.png){fig-align="center"}

Se abrirá el editor de composiciones con un lienzo en blanco y una barra de herramientas lateral:

![Lienzo vacío del editor de composiciones](figures/tarea03/tarea3_016.png){fig-align="center"}
...
**16.** Selecciona **"Añadir mapa"** (ícono de rectángulo con lupa) y dibuja un rectángulo en el lienzo. QGIS insertará automáticamente la vista actual del mapa.

![Composición de mapa - añadir mapa](figures/tarea03/tarea3_017.png){fig-align="center"}

**17.** **Agregar la leyenda.** Selecciona **"Añadir leyenda"** y dibuja un rectángulo donde deseas que aparezca. En el panel **"Propiedades del elemento"** puedes ajustar los títulos, mostrar u ocultar capas y cambiar el orden de los elementos.

![Composición de mapa - añadir leyenda](figures/tarea03/tarea3_023.png){fig-align="center"}
...
![Composición de mapa - añadir escala](figures/tarea03/tarea3_024.png){fig-align="center"}
...
![Composición de mapa - añadir rosa de los vientos](figures/tarea03/tarea3_023.png){fig-align="center"}
...
**20.** **Agregar un título.** Selecciona **"Añadir etiqueta"** (ícono **"T"**), dibuja un cuadro y escribe el texto del título. Ajusta el tamaño, fuente y alineación desde las propiedades.

![Composición de mapa - añadir título](figures/tarea03/tarea3_020.png){fig-align="center"}
...
![Composición de impresión completa con mapa, leyenda, escala, norte y título](figures/tarea03/tarea3_024.png){fig-align="center"}
...
![Exportación de composición a PDF](figures/tarea03/tarea3_028.png){fig-align="center"}

::: callout-tip
## ¿Imagen o PDF?

Ambos formatos tienen ventajas y desventajas según el uso que le darás al mapa:

| | **Imagen (PNG/JPG)** | **PDF** |
|---|---|---|
| **Ventajas** | Compatible con cualquier programa; fácil de insertar en Word, PowerPoint o documentos web | Vectorial: escala sin perder calidad; ideal para impresión profesional |
| **Desventajas** | Resolución fija: si se amplía, pierde nitidez | Más difícil de insertar directamente en algunos programas |
| **Cuándo usarlo** | Presentaciones, sitios web, informes digitales | Impresión de alta calidad, entrega de mapas finales |

Para las entregas del curso, se recomienda exportar como **imágen PNG a 300 dpi**. La resolución (dpi = dots per pixel) se selecciona en en el dialogo de exportación que se abre al seleccionar "Exportar como Imagen". Si bien una mayor resolución otorga una imágen que pierde menos nitidez al hacer zoom, tiene como contrapartida mayor peso: 300 dpi entrega un buen compromiso entre resolución y peso. Al exportar como PDF no es necesario seleccionar la resolución, ya que la imagen se escala.
:::
...
![Mapa exportado — Pobreza Multidimensional y Asentamiento de Comunidades Indígenas en La Araucanía](figures/tarea03/tarea3_029.png){fig-align="center"}

::: callout-tip
**¡Listo!** Has finalizado tu segundo mapa. Recuerda guardar tu trabajo para poder utilizarlo en la entrega de tu próximo portafolio.
:::
