...
![](../figures/clase05/slide_13_img_1.png){width="90%"}
:::
::: {.column width="48%"}
::: {.box}
**Lo malo**
...
![](../figures/clase05/slide_14_img_1.jpg){width="90%"}
:::
:::
...
![](../figures/clase05/slide_15_img_1.jpg){width="90%"}
:::
::: {.column width="48%"}
::: {.box}
**Lo malo**
...
![](../figures/clase05/slide_16_img_1.jpg){width="90%"}
:::
:::
...
![](../figures/clase05/slide_18_img_1.jpg){width="90%"}
:::
::: {.column width="48%"}
::: {.box}
**Lo malo**
...
![](../figures/clase05/slide_19_img_1.jpg){width="90%"}

![](../figures/clase05/slide_20_img_1.jpg){width="90%"}
:::
:::

---

## Energía nuclear {.compact}
...
![](../figures/clase05/slide_21_img_1.jpg){width="90%"}
:::
::: {.column width="48%"}
::: {.box}
**Lo malo**
...
![](../figures/clase05/slide_25_img_1.jpg){width="90%"}
:::
::: {.column width="48%"}
::: {.box}
**Lo malo**
...
![](../figures/clase05/slide_26_img_1.jpg){width="90%"}
:::
:::
...
![](../figures/clase05/slide_27_img_1.jpg){width="90%"}
:::
::: {.column width="48%"}
::: {.box}
**Lo malo**
...
![](../figures/clase05/slide_28_img_1.jpg){width="90%"}
:::
:::
...
## Dos razones para la transición
...
::: columns
::: {.column width="48%"}
Los salares donde se extrae litio son **territorios ancestrales** de los pueblos Atacameño y Colla, protegidos por la Ley 19.253

Chile ratificó el **Convenio 169 de la OIT** en 2008, que obliga a consultar a los pueblos indígenas afectados

Sin embargo, la consulta:

- No es vinculante (la Corte Suprema ha confirmado que no requiere **consentimiento**)
- Tiene plazos comprimidos (la fase deliberativa del contrato ENAMI duró solo 3 meses)
- Excluye a comunidades no directamente adyacentes a los salares
:::
::: {.column width="48%"}
::: {.box}
**La sombra del cobre**
...
- Entre 1997–2000 hubo contaminación con plomo y arsénico en el Loa — nunca reconocida oficialmente
- La expansión del tranque de relaves Talabre (2012) fragmentó a las comunidades
:::
...
::: {.caption}
Fuente: CR2 (2025). "¿Hacia una nueva zona de sacrificio? Fiebre del litio y desconfianza indígena." Álvarez Garretón et al. (2023). *Seguridad Hídrica en Chile*.
:::


## La historia del cobre: una advertencia {.compact}

::: columns
::: {.column width="48%"}
La historia de la minería del cobre en el norte de Chile muestra qué pasa cuando la extracción avanza **sin participación efectiva** de las comunidades:

- En los **años 80**, comunidades indígenas fueron desinformadas sobre el registro de derechos de agua — perdieron acceso legal a sus propias fuentes
- **CODELCO** canalizó completamente el **Río San Pedro**, alterando un ecosistema del que dependían comunidades atacameñas
:::
::: {.column width="48%"}
- Entre **1997–2000**, hubo contaminación con plomo y arsénico en el **Río Loa** — nunca reconocida oficialmente
- La expansión del **tranque de relaves Talabre** (2012) fragmentó físicamente a comunidades, dividiendo territorios ancestrales

::: {.box}
El patrón: promesas de desarrollo → impactos ambientales → comunidades que cargan con los costos → desconfianza profunda
:::
:::
:::
...
- La consulta indígena **no es vinculante** — no requiere consentimiento
...
::: {.caption}
Para profundizar: CR2 (2025). ["¿Hacia una nueva zona de sacrificio? Fiebre del litio y desconfianza indígena."](https://www.cr2.cl/hacia-una-nueva-zona-de-sacrificio-fiebre-del-litio-y-desconfianza-indigena-tercera-dosis/)
:::
:::
:::
...
- Tabla de atributos: exploración, filtrado, edición
- Join no espacial (combinar tablas)
- Exportación de capas a GeoPackage
- Composición de impresión con dos mapas
