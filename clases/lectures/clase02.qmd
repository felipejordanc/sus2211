...
## Stgo: quién contamina y quién sufre
...
::: columns
::: {.column width="49%"}
- Industrias contaminantes buscan **terrenos baratos** y **poca oposición**
...
## JA para riesgos "naturales" 

::: columns
::: {.column width="56%"}
- En Stgo, barrios ricos en **precordillera** — origen de aluviones
- \+ construcciones → + escorrentía → + inundaciones **aguas abajo**
- Obras de mitigación se concentran en barrios ricos
- Pobres, aguas abajo, quedan **desprotegidos**
...
::: {.caption}
El oriente concentra los sectores de mayores ingresos en Stgo. Fuente: Vergara, Parra, Núñez. (2020), “Contra el urbanismo de la desigualdad: propuestas para el futuro de nuestras ciudades”, CIPER Académico.
:::
:::
:::
...
Vuelvan a juntarse en los mismos grupos, escojar un caso de JA ilustrado por la herramienta, y respondan las siguientes perguntas guías.
...
## Discusión en plenario {.activity-slide}
  ...
  1. Un grupo de cada herrameinta presenta en 2 minutos su caso, utilizando la herramienta para ilustrarlo.
