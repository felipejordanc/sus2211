...
::: {.column width="65%"}
::: {.two-level}
- Ing. Comercial y M.S. economía, U. de Chile, Ph.D. Pol. Economy & Gov., Harvard
- Profesor asistente Inst. Economía e Inst. para el Desarrollo Sustentable, PUC
- Área de interés:
  - Desarrollo sostenible en territorios rurales de LATAM
  - Deforestación, a escala global y local
- <a href="https://www.felipejordanc.com/" target="_blank">Página web</a>
:::
:::
::: {.column width="33%"}
![](../figures/clase01/HeadShot.png){width="100%"}
:::
:::
...
- **Lunes siguiente, bloque 3:** Taller guía *(comienza el lunes 23)*
...
::: {.two-level}
- El uso de Inteligencia Artificial Generativa (IAG) **está permitido**
...
## ¿Nos restringe la geografía? {.question-slide}

![](../figures/clase01/slide_28_img_1.png){width="70%"}



# CT: La Encrucijada de la Insustentabilidad {.section-slide background-color="#2a7f62"}

## El choque con la finitud
...
::: columns
::: {.column width="48%"}
![](../figures/clase01/slide_31_img_1.png){width="100%"}
:::
::: {.column width="48%"}
![](../figures/clase01/slide_32_img_1.png){width="100%"}
:::
:::
...
![](../figures/clase01/slide_33_img_1.png){width="100%"}
...
![](../figures/clase01/slide_34_img_1.jpg){width="100%"}
...
::: columns
::: {.column width="48%"}
![](../figures/clase01/slide_35_img_1.png){width="100%"}
:::
::: {.column width="48%"}
![](../figures/clase01/slide_36_img_1.png){width="100%"}
:::
:::
...
## Nuestro hogar... {.map-slide}

![](../figures/clase01/slide_38_img_1.png){width="85%"}

---

## ...pequeño punto azul en el espacio inconmesurable {.map-slide}
...
::: columns
::: {.column width="35%"}
A la vez que actuamos para recuperar la estabilidad del sistema Tierra, debemos superar definitivamente la pobreza y cerrar desigualdades crónicas
::: 
::: {.column width="63%"}
![](../figures/clase01/slide_44_img_1.png){width="100%"}

::: {.caption}
Bastas regiones del mundo aun viven en la pobreza.
::: 
...
:::
::: {.column width="58%"}
![](../figures/clase01/slide_45_img_1.png){width="80%"}

::: {.caption}
La mayoría de los paises han alcanzado mayores niveles de desarrollo humano a costa del deterioro ambiental
::: 
...
::: {.caption}
La humanidad ha superado desafíos inmensos en el pasado
::: 
...
## Visualización de Justicia Ambiental {.activity-slide}
